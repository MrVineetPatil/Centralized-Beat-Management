	...
	<v-app>
		...
		<v-toolbar fixed app :clipped-left="clipped">
			...
			<v-toolbar-title class="primary--text">
				<router-link to="/" tag="span" style="cursor: pointer"><v-icon color="blue darken-2">fingerprint people smartphone</v-icon>Beat Management Portal</router-link>
			</v-toolbar-title>
			<v-spacer></v-spacer>
		...
		<v-footer :fixed="fixed" app>
			<span>&copy; 2019 Kruthika K</span>
		</v-footer>
	</v-app>
</template>
